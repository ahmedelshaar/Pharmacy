...
@section('title', 'Show Doctor: ' . $doctor->name)
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <img src="{{ asset($doctor['image']) }}" style="height: 250px; width: 250px; object-fit: cover"
                             alt="{{ $doctor['name'] }}">
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="pharmacy_id" class="form-control" readonly
                               value="{{ $doctor->pharmacy->name }}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input" onclick="return false;" id="is_banned" type="checkbox"
                                   value="1" name="is_banned" @if($doctor->is_banned) checked @endif>
